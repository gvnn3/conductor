...
from conductor.json_protocol import (
    send_message, receive_message, MSG_PHASE, MSG_RUN, MSG_RESULT,
    MSG_CONFIG, MSG_DONE, MSG_ERROR
)
...
class TestJSONProtocolProperties:
    ...
    @given(
        msg_type=st.sampled_from([MSG_PHASE, MSG_RUN, MSG_RESULT, MSG_CONFIG, MSG_DONE, MSG_ERROR]),
