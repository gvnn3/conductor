...
from conductor.protocol import (
    Message, MessageType, ProtocolError,
    send_json_message, receive_json_message,
    phase_to_dict, step_to_dict, result_to_dict,
    phase_from_dict, step_from_dict, retval_from_dict,
    ProtocolHandler
)
...
class TestMessage:
    ...
    def test_message_from_json(self):
        ...
        json_str = '{"version": 1, "type": "result", "payload": {"code": 0, "message": "OK"}}'
